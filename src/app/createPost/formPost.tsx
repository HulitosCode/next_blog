...
const FormPost = ({
  ...
  // fetch list tags
  const { data: dataTag, isLoading: isLoadingTags } = useQuery<Tag[]>({
    queryKey: ["tags"],
    queryFn: async () => {
  ...
  console.log(dataTag); // Verificando os dados de tags no console
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select onValueChange={field.onChange} value={field.value}>
                      ...
                      <SelectContent>
                        {/* Mapeando as tags dinamicamente */}
                        {dataTag?.map((tag) => (
